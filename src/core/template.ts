...
const template = (routeName: string, openRoute: (event: Event, route: "home" | "map" | "settings") => void ) => {
    ...
    return html`
        <div class="grid">
            <main class="${routeName}-active" id="main">
                ...
                ${routeName === 'home' ? html`<tickets-list part="content" id="tickets-list"></tickets-list>` : ''}
                ${routeName === 'map' ? html`<map-embed part="content"></map-embed>` : ''}
                ${routeName === 'settings' ? html`<settings-info part="content"></settings-info>` : ''}
            </main>
            <nav id="navigation-bar" class="${routeName}-active">
                <a id="map-button" class="link-button" href="/map" @click="${($event: Event) => { openRoute($event, 'map') }}" title="map">
                ...
                <a id="ticket-button" class="link-button" href="/" @click="${($event: Event) => { openRoute($event, 'home') }}" title="ticket">
                ...
                <a id="settings-button" class="link-button" href="/settings" @click="${($event: Event) => { openRoute($event, 'settings') }}" title="settings">
